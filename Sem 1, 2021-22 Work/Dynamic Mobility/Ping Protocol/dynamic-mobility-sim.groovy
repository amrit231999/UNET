...
simulate T, {
  ...
  def n1 = node('0', address: 6, location: [-4880.m, 0.m, -1.m], mobility: true, stack: { container ->
            container.add 'ping', new dynamic_mobility_node_B()
          })
  def n = node('AUV-3', address: 100, location: [20.m, 0.m, -1.m], mobility: true, stack: { container ->
