...
for(int i=0; i<sim; i++){
  ...
  simulate T ,{
    ...
    node 'C', address: 31, location: [-200.m, 0, -500.m],  stack: { container ->
      container.add 'ping', new plumec()
  
    }
    
    node 'D', address: 32, location: [-100.m, 0, -500.m],  stack: { container ->
      container.add 'ping', new plumec()
  
    }
    
    node 'E', address: 33, location: [0, 0, -500.m],  stack: { container ->
      container.add 'ping', new plumec()
      
    }
    
   
     node 'F', address: 34, location: [100.m, 0, -500.m],  stack: { container ->
      container.add 'ping', new plumec()
      
    }
  
     node 'G', address: 35, location: [200.m, 0, -500.m],  stack: { container ->
      container.add 'ping', new plumec()
      
    }

     def n1 = node 'X', address: 41, location: [200.m, 0, 0], mobility: true , stack: { container ->
      container.add 'ping', new plumec()
    ...
    n1.motionModel=[
     ...
     def n2 = node 'Y', address: 42, location: [300.m, 0, 0], mobility: true , stack: { container ->
      container.add 'ping', new plumec()
     ...
     node 'B', address: 21, location: [0, 0, 0],  stack: { container ->
      container.add 'ping', new plumec()
