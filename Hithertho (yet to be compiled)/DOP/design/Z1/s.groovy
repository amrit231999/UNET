...
simulate T, {
  ...
  def n1 = node 'X', address: 101, location: [1.m, 0, 0], mobility: true , stack: { container ->
      container.add 'ping', new f()
  
    }
    n1.motionModel=[
      speed:3.mps]
    
  def n2 = node 'Y', address: 102, location: [1.m, 0, 0], mobility: true , stack: { container ->
      container.add 'ping', new f2()
