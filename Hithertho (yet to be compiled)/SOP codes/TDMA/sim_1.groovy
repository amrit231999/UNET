...
channel = [
  ...
  temperature:          25.C,
  salinity:             35.ppt,
  noiseLevel:           65.dB,   //PSD of ambient noise
...
for(int i=0; i<sim; i++){
  ...
  simulate T ,{
    ...
    node 'C', address: 31, location: [180.m, 0, -1000.m],  stack: { container ->
      container.add 'ping', new tdma_1()
  
    }
    
    node 'D', address: 32, location: [-150.m, 50.m, -1000.m],  stack: { container ->
      container.add 'ping', new tdma_1()
  
    }
    
    node 'E', address: 33, location: [50.m, 50.m, -1000.m],  stack: { container ->
      container.add 'ping', new tdma_1()
      
    }
    
   
     node 'F', address: 34, location: [100.m, 100.m, -1000.m],  stack: { container ->
      container.add 'ping', new tdma_1()
      
    }
  
    node 'G', address: 35, location: [200.m, 0, -1000.m],  stack: { container ->
      container.add 'ping', new tdma_1()
      
    }
  
    node 'B', address: 21, location: [0, 0, -1000.m],  stack: { container ->
      container.add 'ping', new tdma_1()
      
    }
  
    node 'A', abcd: 10, address: 10, location: [0.m, 0.m, 0.m], stack: { container ->
      container.add 'ping', new tdma_1()
    }
